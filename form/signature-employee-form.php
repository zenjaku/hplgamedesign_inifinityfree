...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['e-signature'])) {
    ...
    echo "<script>window.location.href = '/inventory-custody?employee_id=$employee_id';</script>";
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['a-signature'])) {
    ...
    echo "<script>window.location.href = '/inventory-custody?username=$username';</script>";
    exit();
}
?>